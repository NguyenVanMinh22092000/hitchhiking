...
class CTooltip extends Component {
    ...
    render() {
        ...
        const { classes, children, title, placement, noneWrap, center, className, Comp, style, hidden, arrow, disableInteractive = true } = this.props;
...
CTooltip.propTypes = {
    ...
    disableInteractive: PropTypes.number,
};

export default withStyles(styles)(CTooltip);